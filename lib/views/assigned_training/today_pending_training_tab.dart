...
class TodayPendingTab extends StatefulWidget
{
  PendingState createState()=>PendingState();
}

class PendingState extends State<TodayPendingTab>
{
            ...
            itemBuilder: (BuildContext context,int pos)
            {
              return Column(
                children: [
                  ...
                  GestureDetector(
                    onTap:(){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>SelfTrainingScreen(pendingTrainingList[pos]["id"].toString(),0.0,"given")));
                        ...
                        children: [
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  child: CachedNetworkImage(
                                      imageUrl:pendingTrainingList[pos]["thumbnail"]??"",
                          ...
                          Expanded(child: Column(
                            ...
                            children: [
                              ...
                              Text(
                               parseServerFormatDate(pendingTrainingList[pos]["start_date_time"].toString()),
                                style: TextStyle(
                                    fontSize: 13,
                                    fontWeight: FontWeight.w500,
                                    color: Colors.black),
  ...
  fetchPendingTasks(BuildContext context) async {
    ...
    var response = await helper.postAPI('give-training/pending-trainings', data, context);
    isLoading=false;
    var responseJSON = json.decode(response.body);
    print(responseJSON);
    pendingTrainingList=responseJSON["data"];
    setState(() {
