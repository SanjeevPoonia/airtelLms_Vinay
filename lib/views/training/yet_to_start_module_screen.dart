...
class YetToStartModule2Screen extends StatefulWidget
{
  ModuleState createState()=>ModuleState();
}
class ModuleState extends State<YetToStartModule2Screen>
{
         ...
         Container(
           ...
           child: Row(
             children: [
              ...
              // Image.asset("assets/search_ic.png",width:20,height: 20),
                                                       ...
                                                       children: [
                                                         ...
                                                         Column(
                                                           children: [
                                                             ...
                                                             Text(
                                                               fetchDays(coursesList[pos]["courses"][pos22]["time_left"]),
                                                               style: TextStyle(
                                                                   fontSize: 12,
  ...
  fetchModules(BuildContext context) async {
    ...
    var response = await helper.postAPI('yet-to-start-module', data, context);
    isLoading=false;
