...
class CompletedQuizTab extends StatefulWidget
{
  ModuleState createState()=>ModuleState();
}
class ModuleState extends State<CompletedQuizTab>
{
  @override
                   ...
                   children: [
                     ...
                     Container(
                       ...
                       child: ElevatedButton(
                           ...
                           child: const Text("View Details", style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500))),
                     ),
                   ],
                 )),
           )
