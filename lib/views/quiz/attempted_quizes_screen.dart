...
class AttemptedQuizScreen extends StatefulWidget
{
  ModuleState createState()=>ModuleState();
}
class ModuleState extends State<AttemptedQuizScreen>
{
  ...
  fetchQuizList(BuildContext context) async {
    ...
    var response = await helper.postAPI('completed-test', data, context);
    isLoading=false;
